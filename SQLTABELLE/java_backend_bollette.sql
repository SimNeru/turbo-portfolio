...
CREATE TABLE `bollette` (
  ...
  `dataScadenza` varchar(50) DEFAULT NULL,
  `intestatario` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `bollette` VALUES (1,'luce',20.50,100.00,'30/06/2024','Pino'),(2,'gas',43.60,200.00,'30/05/2024','Abete'),(3,'luce',69.69,250.00,'30/08/2024','Cipresso');
